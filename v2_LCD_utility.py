...
11/19/22 - add ability to deal with None message lines (e.g. lines 3 and 4)
'''
...
'''
tool for creating custom chars:  https://maxpromer.github.io/LCD-Character-Creator/
'''
custom_char_dict = {
    ...
    'wave1': [0x00, 0x00, 0x02, 0x0C, 0x1F, 0x00, 0x00, 0x00],
    'wave2': [0x00, 0x00, 0x00, 0x0C, 0x1F, 0x00, 0x00, 0x00],
    'person1': [0x0C, 0x0E, 0x14, 0x0E, 0x05, 0x04, 0x0A, 0x0A],
    'person2': [0x06, 0x0E, 0x05, 0x0E, 0x14, 0x04, 0x0A, 0x0A],
    'buoy': [0x04, 0x0E, 0x0E, 0x0E, 0x1F, 0x00, 0x00, 0x00],
    }
