...
description:
    Import class with various RPi utility methods
    from v2_RPi_utilities import RPi_utilities
...
class RPi_utilities:
    def get_time_stamp(self, local_time_zone='UTC', time_format='HMS'):
    ...
    def get_time(self, local_time_zone='UTC'):
        now_local = datetime.now(pytz.timezone(local_time_zone))
    ...
    def get_hwclock_time(self):
        time_string = os. system("sudo hwclock -r")


    #### RPI UTILITIES ####
    def setRTC(self, year, month, date, hour, minute):
    ...
    def get_directory_size(self, dir_path, use_cwd=True):
    ...
    def copy_SW(self, usb_path, usb_file_pathname, file_pathname, sudo=False):
