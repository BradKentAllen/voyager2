#!python3.7  ads1115 Driver
''' driver for ads1115 A to D converter
Originally came from pypi
Only minor modifications such as changing to smbus
'''

import signal  # for keyboard interrupt
import time
#import smbus2 # originally had this but can't see that it is needed
